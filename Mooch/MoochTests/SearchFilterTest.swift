...
class SearchFilterTest: XCTestCase {
    ...
    func testSortOrderByPrice() {
        ...
        let user = User(id: 4, name: "test", contactInformation: contactInformation, communityId:4 , pictureURL: "sample person pic", thumbnailPictureURL: "small pic")
        ...
        let listingApple = Listing(id: 1, photo:photoImage1,title: "apple", description: "nice apple", price: 1.0, isFree: false, quantity: 2, categoryId: 3, isAvailable: true, createdAt: createDate as Date, modifiedAt: modifyDate as Date, owner: user, pictureURL: "picture",thumbnailPictureURL: "thumbPic", communityId: 4,exchanges: [exchanges], dominantColor: .orange)

        let listingBanana = Listing(id: 2, photo:photoImage2,title: "banana", description: "nice banana", price: 2.0, isFree: false, quantity: 2, categoryId: 3, isAvailable: true, createdAt: createDate1 as Date, modifiedAt: modifyDate1 as Date, owner: user, pictureURL: "picture",thumbnailPictureURL: "thumbPic", communityId: 4,exchanges: [exchanges], dominantColor: .orange)


        let listingPair = Listing(id: 3, photo:photoImage3,title: "Pair", description: "nice Pair", price: 3.0, isFree: false, quantity: 2, categoryId: 3, isAvailable: true, createdAt: createDate2 as Date, modifiedAt: modifyDate2 as Date, owner: user, pictureURL: "picture",thumbnailPictureURL: "thumbPic", communityId: 4,exchanges: [exchanges], dominantColor: .orange)
    ...
    func testSortByCategory() {
        ...
        let listingChips = Listing(id: 3, photo:photoImage3,title: "Chips", description: "nice Chips", price: 3.0, isFree: false, quantity: 2, categoryId: 2, isAvailable: true, createdAt: createDate2 as Date, modifiedAt: modifyDate2 as Date, owner: user, pictureURL: "picture",thumbnailPictureURL: "thumbPic", communityId: 4,exchanges: [exchanges], dominantColor: .orange)

        let listingEnergyBar = Listing(id: 3, photo:photoImage3,title: "EnergyBar", description: "nice EnergyBar", price: 3.0, isFree: false, quantity: 2, categoryId: 2, isAvailable: true, createdAt: createDate2 as Date, modifiedAt: modifyDate2 as Date, owner: user, pictureURL: "picture",thumbnailPictureURL: "thumbPic", communityId: 4,exchanges: [exchanges], dominantColor: .orange)
